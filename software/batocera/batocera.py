#!/usr/bin/python3
"""Software for the Software BATOCERA"""
...
class Batocera(AbstractSoftware):
    """Software for the Software BATOCERA"""
    ...
    def get_default_media_associations(self) -> dict[Media, str]:
        ...
        media_associations: dict[Media, str] = {
            Media.SCREENSHOT_MIX: 'image',
            Media.LOGO_CARBON: 'marquee',
            Media.BOX_3D: 'thumbnail',
            Media.FAN_ART: 'fanart',
            Media.SCREENSHOT_TITLE: 'titleshot',
            Media.BOX_2D: 'boxback',
            Media.BEZEL: 'bezel',
            Media.MANUAL: 'manual',
            Media.VIDEO: 'video'
        }
    ...
    def get_default_media_positions(self) -> dict[tuple[int, int], Media]:
        ...
        media_positions: dict[tuple[int, int], Media] = {
            (0, 0): Media.SCREENSHOT_MIX,
            (0, 1): Media.LOGO_CARBON,
            (0, 2): Media.BOX_3D,
            (0, 3): Media.FAN_ART,
            (1, 0): Media.SCREENSHOT_TITLE,
            (1, 1): Media.BOX_2D,
            (1, 2): Media.BEZEL,
            (1, 3): Media.MANUAL,
            (2, 0): Media.VIDEO
    ...
    def retrieve_media_files(self, platform: str, game_item: dict) -> dict[Media, str]:
        ...
        for key, value in game_data.items():
            media = self.retrieve_media(resource=key)
            if media is None:
                continue
